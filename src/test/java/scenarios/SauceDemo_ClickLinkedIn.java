...
public class SauceDemo_ClickLinkedIn extends TestBase {
	
	@Test
	public void testScenario() throws Exception   {
		
		TestDataHandler testDataHandler = new TestDataHandler();
		ReportLog.setTestName("SauceDemo - LinkedIn page");
		ReportLog.setTestCase("Verify user can navigate to Swag Labs' LinkedIn Page");
		
		footers.clickLinkedIn();
